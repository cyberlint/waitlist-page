...
import firstImage from "../assets/Course app-pana.png";
import secondImage from "../assets/Online learning-cuate.png";
import thirdImage from "../assets/Online learning-bro.png";
import fourthImage from "../assets/Online learning-pana.png";
...
const SecondSection = ({ classesRef }) => {
  ...
  return (
    <main
      ref={classesRef}
      className="w-[90%] mb-30 rounded-lg flex flex-col lg:flex-row justify-between items-center"
    >
